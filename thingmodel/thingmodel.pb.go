...
type ThingModelMsg struct {
	...
	DeviceId      int64                            `protobuf:"varint,2,opt,name=deviceId,proto3" json:"deviceId,omitempty"` // 下发的目标设备id
...
func (x *ThingModelMsg) GetDeviceId() int64 {
	if x != nil {
		return x.DeviceId
	}
	return 0
...
type ThingModelIssueMsg struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DeviceId      int64                  `protobuf:"varint,1,opt,name=deviceId,proto3" json:"deviceId,omitempty"` // 下发的目标设备id
...
var file_thingmodel_thingmodel_proto_rawDesc = string([]byte{
	...
	0x03, 0x52, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x3f, 0x0a, 0x0d, 0x6f,
	...
	0x2f, 0x6c, 0x6f, 0x73, 0x74, 0x76, 0x69, 0x70, 0x2d, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x76, 0x5f,
	0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x5f, 0x70, 0x72, 0x6f, 0x74,
