...
type AddDevice struct {
	...
	DeviceSn      string                 `protobuf:"bytes,3,opt,name=deviceSn,proto3" json:"deviceSn,omitempty"`
...
func (x *AddDevice) GetProductCode() string {
	if x != nil {
		return x.ProductCode
	}
	return ""
...
func (x *AddDevice) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
type Request struct {
	...
	IotPlatform string                 `protobuf:"bytes,2,opt,name=iotPlatform,proto3" json:"iotPlatform,omitempty"`
...
func (x *Request) GetIotPlatform() string {
	if x != nil {
...
func (x *Request) GetAddDevice() *AddDevice {
	if x != nil {
		if x, ok := x.Param.(*Request_AddDevice); ok {
			return x.AddDevice
		}
	}
	return nil
...
type Request_AddDevice struct {
	AddDevice *AddDevice `protobuf:"bytes,4,opt,name=addDevice,proto3,oneof"`
}

func (*Request_DeviceCode) isRequest_Param() {}

func (*Request_AddDevice) isRequest_Param() {}
...
const file_device_device_proto_rawDesc = "" +
	"\n" +
	"\x13device/device.proto\x12\x06device\"\xed\x01\n" +
	"\x06Device\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vproductCode\x18\x03 \x01(\tR\vproductCode\x12\x1a\n" +
	"\bdeviceSn\x18\x04 \x01(\tR\bdeviceSn\x12\x16\n" +
	"\x06secret\x18\x05 \x01(\tR\x06secret\x12/\n" +
	"\x05extra\x18\x06 \x03(\v2\x19.device.Device.ExtraEntryR\x05extra\x1a8\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	...
	"\bdeviceSn\x18\x03 \x01(\tR\bdeviceSn\x122\n" +
	"\x05extra\x18\x04 \x03(\v2\x1c.device.AddDevice.ExtraEntryR\x05extra\x1a8\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\viotPlatform\x18\x02 \x01(\tR\viotPlatform\x12 \n" +
	"\n" +
	"deviceCode\x18\x03 \x01(\tH\x00R\n" +
	"deviceCode\x121\n" +
	"\taddDevice\x18\x04 \x01(\v2\x11.device.AddDeviceH\x00R\taddDeviceB\a\n" +
	"\x05param\"\xdd\x01\n" +
	"\bResponse\x12\x18\n" +
	...
	"\bUNACTIVE\x10\x02\x12\v\n" +
	"\aDISABLE\x10\x03\x12\v\n" +
	"\aUNKNOWN\x10\x042\xb0\x02\n" +
	"\tRpcDevice\x12.\n" +
	...
	"\x06Delete\x12\x0f.device.Request\x1a\x10.device.Response\"\x00B\x85\x01\n" +
	"\n" +
	"com.deviceB\vDeviceProtoP\x01Z2github.com/lostvip-com/lv_grpc_driver_proto/device\xa2\x02\x03DXX\xaa\x02\x06Device\xca\x02\x06Device\xe2\x02\x12Device\\GPBMetadata\xea\x02\x06Deviceb\x06proto3"
...
var file_device_device_proto_goTypes = []any{
	...
	(*AddDevice)(nil),  // 2: device.AddDevice
	(*Request)(nil),    // 3: device.Request
	(*Response)(nil),   // 4: device.Response
	nil,                // 5: device.Device.ExtraEntry
	nil,                // 6: device.AddDevice.ExtraEntry
}
var file_device_device_proto_depIdxs = []int32{
	5,  // 0: device.Device.extra:type_name -> device.Device.ExtraEntry
	6,  // 1: device.AddDevice.extra:type_name -> device.AddDevice.ExtraEntry
	2,  // 2: device.Request.addDevice:type_name -> device.AddDevice
	0,  // 3: device.Response.status:type_name -> device.ConnectStatus
	1,  // 4: device.Response.device:type_name -> device.Device
	3,  // 5: device.RpcDevice.Connect:input_type -> device.Request
	3,  // 6: device.RpcDevice.Disconnect:input_type -> device.Request
	3,  // 7: device.RpcDevice.GetStatus:input_type -> device.Request
	3,  // 8: device.RpcDevice.QueryByCode:input_type -> device.Request
	3,  // 9: device.RpcDevice.Save:input_type -> device.Request
	3,  // 10: device.RpcDevice.Delete:input_type -> device.Request
	4,  // 11: device.RpcDevice.Connect:output_type -> device.Response
	4,  // 12: device.RpcDevice.Disconnect:output_type -> device.Response
	4,  // 13: device.RpcDevice.GetStatus:output_type -> device.Response
	4,  // 14: device.RpcDevice.QueryByCode:output_type -> device.Response
	4,  // 15: device.RpcDevice.Save:output_type -> device.Response
	4,  // 16: device.RpcDevice.Delete:output_type -> device.Response
...
func file_device_device_proto_init() {
	...
	file_device_device_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*Request_AddDevice)(nil),
	}
	file_device_device_proto_msgTypes[3].OneofWrappers = []any{
		(*Response_Status)(nil),
		(*Response_Device)(nil),
	}
	type x struct{}
