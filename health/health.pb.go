...
const file_health_health_proto_rawDesc = "" +
	...
	"\x0fSERVICE_UNKNOWN\x10\x032\xb2\x01\n" +
	"\x06Health\x12R\n" +
	"\x05Check\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse\"\x00\x12T\n" +
	"\x05Watch\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse\"\x000\x01B\xb8\x01\n" +
	"\x12com.grpc.health.v1B\vHealthProtoP\x01Z;github.com/lostvip-com/lv_grpc_driver_proto/health;healthv1\xa2\x02\x03GHX\xaa\x02\x0eGrpc.Health.V1\xca\x02\x0eGrpc\\Health\\V1\xe2\x02\x1aGrpc\\Health\\V1\\GPBMetadata\xea\x02\x10Grpc::Health::V1b\x06proto3"
