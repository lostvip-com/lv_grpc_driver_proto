...
const (
	...
	Common_Version_FullMethodName = "/driver.Common/Version"
)
...
const (
	CloudInstanceService_DriverRegister_FullMethodName = "/driver.CloudInstanceService/DriverRegister"
)
...
type CloudInstanceServiceClient interface {
	DriverRegister(ctx context.Context, in *DriverRegisterRequest, opts ...grpc.CallOption) (*DriverRegisterResponse, error)
}
...
func (c *cloudInstanceServiceClient) DriverRegister(ctx context.Context, in *DriverRegisterRequest, opts ...grpc.CallOption) (*DriverRegisterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DriverRegisterResponse)
	err := c.cc.Invoke(ctx, CloudInstanceService_DriverRegister_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CloudInstanceServiceServer interface {
	DriverRegister(context.Context, *DriverRegisterRequest) (*DriverRegisterResponse, error)
...
func (UnimplementedCloudInstanceServiceServer) DriverRegister(context.Context, *DriverRegisterRequest) (*DriverRegisterResponse, error) {
...
func _CloudInstanceService_DriverRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DriverRegisterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CloudInstanceServiceServer).DriverRegister(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CloudInstanceService_DriverRegister_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudInstanceServiceServer).DriverRegister(ctx, req.(*DriverRegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CloudInstanceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "driver.CloudInstanceService",
	HandlerType: (*CloudInstanceServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DriverRegister",
			Handler:    _CloudInstanceService_DriverRegister_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "driver/driver.proto",
