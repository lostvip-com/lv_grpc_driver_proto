...
type DriverReportPlatformInfoRequest struct {
	state            protoimpl.MessageState   `protogen:"open.v1"`
	DriverInstanceId int64                    `protobuf:"varint,1,opt,name=driverInstanceId,proto3" json:"driverInstanceId,omitempty"`
...
func (x *DriverReportPlatformInfoRequest) GetDriverInstanceId() int64 {
	if x != nil {
...
var file_cloudinstance_cloudinstance_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x0f, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x49, 0x6e,
